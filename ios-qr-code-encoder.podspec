#
#  Be sure to run `pod spec lint ios-qr-code-encoder.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/oenius/ios-qr-code-encoder"
  ...
  s.source       = { :git => "https://github.com/oenius/ios-qr-code-encoder.git", :tag => "v1.0.0" }
